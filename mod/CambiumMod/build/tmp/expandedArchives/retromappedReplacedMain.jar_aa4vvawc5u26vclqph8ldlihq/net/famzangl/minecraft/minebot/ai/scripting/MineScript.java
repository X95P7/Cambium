...
public class MineScript {
	...
	public FoundEntity getPlayer() {
		return new FoundEntity(waitForTick().getMinecraft().field_71439_g);
	}
	...
	public Object getEntities(String entityDescr, Object nbtO)
		...
		List<Entity> entities = PlayerSelector.func_179656_b(
				new ICommandSender() {
					@Override
					public void func_174794_a(Type type, int amount) {
					...
					public BlockPos func_180425_c() {
						return helper.getMinecraft().field_71439_g.func_180425_c();
					}
					...
					public Entity func_174793_f() {
						return helper.getMinecraft().field_71439_g;
					}
		...
		for (Entity e : entities) {
			if (nbt != null) {
				...
				e.func_70109_d(nbttagcompound1);
	...
	public int getExperienceLevel() {
		return waitForTick().getMinecraft().field_71439_g.field_71068_ca;
	}

	public int getCurrentTime() {
		return (int) (waitForTick().getMinecraft().field_71441_e.func_72820_D() % 24000l);
	}

	public InventoryDefinition getInventory() {
		return new InventoryDefinition(
				waitForTick().getMinecraft().field_71439_g.field_71071_by);
	}
