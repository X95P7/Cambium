...
public class TintStrategy extends TaskStrategy {
	...
	public static class DyeItemFilter implements ItemFilter {
		...
		public boolean matches(ItemStack itemStack) {
			...
			return itemStack != null
					...
					&& itemStack.func_77973_b() instanceof ItemDye
					&& (color == null || 15 - itemStack.func_77952_i() == color
							.ordinal());
		}
	...
	public void searchTasks(AIHelper helper) {
		...
		final EntityPlayerSP owner = helper.getMinecraft().field_71439_g;
		// FIXME: Check.
		final EnumDyeColor holdingColor = EnumDyeColor.values()[15 - owner.field_71071_by
				.func_70448_g().func_77952_i()];
