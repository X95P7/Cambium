...
public abstract class FaceInteractStrategy extends AIStrategy {
	...
	protected TickResult onGameTick(AIHelper helper) {
		...
		if (over != null && over.field_72313_a == MovingObjectType.ENTITY
				&& doInteractWithCurrent(over.field_72308_g, helper)) {
			ticksRun = 0;
		} else {
			final double speed = helper.getMinecraft().field_71439_g.field_70159_w
					* helper.getMinecraft().field_71439_g.field_70159_w
					+ helper.getMinecraft().field_71439_g.field_70179_y
					* helper.getMinecraft().field_71439_g.field_70179_y;
