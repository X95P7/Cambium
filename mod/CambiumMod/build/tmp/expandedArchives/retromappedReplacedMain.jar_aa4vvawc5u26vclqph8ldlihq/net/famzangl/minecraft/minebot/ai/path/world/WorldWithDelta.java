...
public class WorldWithDelta extends WorldData {
			...
			if (blockStorage == null) {
				LOGGER.trace(MARKER_WORLD_DELTA,
						"Chunk delta fall through: load block storage for ("
								+ chunkX + "," + chunkZ + ")");
				blockStorage = theWorld.func_72964_e(chunkX, chunkZ)
						.func_76587_i();
			}
	...
	public void setBlock(BlockPos pos, Block block) {
		setBlock(pos, block.func_149682_b(block), 0);
	}

	public void setBlock(BlockPos pos, int blockId, int meta) {
		setBlock(pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p(), blockId, meta);
	}
	...
	public Vec3 getExactPlayerPosition() {
		return new Vec3(playerPosition.func_177958_n() + .5, playerPosition.func_177956_o(),
				playerPosition.func_177952_p() + .5);
	}
