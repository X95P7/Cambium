...
public class FaceAndInteractTask extends AITask {
	...
	public boolean isFinished(AIHelper h) {
		...
		return collect ? preferedAnimal.func_174813_aQ().func_72326_a(
				h.getMinecraft().field_71439_g.func_174813_aQ()) : interacted;
	}
	...
	public void runTick(AIHelper h, TaskOperations o) {
		...
		if (ticksRun > 2 && over != null
				&& over.field_72313_a == MovingObjectType.ENTITY
				&& alsoAcceptedAnimal.apply(over.field_72308_g)) {
			doInteractWithCurrent(h);
		} else {
			final double speed = h.getMinecraft().field_71439_g.field_70159_w
					* h.getMinecraft().field_71439_g.field_70159_w
					+ h.getMinecraft().field_71439_g.field_70179_y
					* h.getMinecraft().field_71439_g.field_70179_y;
			h.face(preferedAnimal.field_70165_t, preferedAnimal.field_70163_u,
					preferedAnimal.field_70161_v);
			final MovementInput i = new MovementInput();
			i.field_78901_c = speed < 0.01 && ticksRun > 8;
			i.field_78900_b = 1;
