...
public class PlaceTorchSomewhereTask extends AITask {
	...
	public void runTick(AIHelper h, TaskOperations o) {
		...
		final BlockItemFilter f = new BlockItemFilter(Blocks.field_150478_aa);
		...
		h.faceSideOf(placeOn, next.dir.func_176734_d());
		if (h.isFacingBlock(placeOn, next.dir.func_176734_d())) {
			h.overrideUseItem();
			delayAfter = 10;
		}
		next.attemptsLeft--;
