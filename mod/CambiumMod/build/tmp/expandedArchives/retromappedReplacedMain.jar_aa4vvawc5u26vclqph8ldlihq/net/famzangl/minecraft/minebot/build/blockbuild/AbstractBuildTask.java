...
public abstract class AbstractBuildTask extends BuildTask {
	...
	public AITask getPlaceBlockTask(BlockPos relativeFromPos) {
		if (!isStandablePlace(relativeFromPos)) {
			...
			return new UpwardsMoveTask(forPosition.func_177982_a(0, 1, 0), getItemToPlaceFilter());
		} else {
			return new SneakAndPlaceTask(forPosition.func_177982_a(0, 1, 0), getItemToPlaceFilter(),
					forPosition.func_177971_a(relativeFromPos), getMinHeightToBuild());
		}
	}
	...
	protected double getMinHeightToBuild() {
		return forPosition.func_177956_o() + getBlockHeight();
	}
