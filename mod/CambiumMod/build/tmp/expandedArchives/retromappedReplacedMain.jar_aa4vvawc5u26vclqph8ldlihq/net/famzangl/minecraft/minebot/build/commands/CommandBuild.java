...
public class CommandBuild {
	...
	public static BlockPos isAroundSite(AIHelper helper, BuildTask task) {
		...
		for (final BlockPos p : task.getStandablePlaces()) {
			final int x = p.func_177958_n() + forPosition.func_177958_n();
			final int y = p.func_177956_o() + forPosition.func_177956_o();
			final int z = p.func_177952_p() + forPosition.func_177952_p();
