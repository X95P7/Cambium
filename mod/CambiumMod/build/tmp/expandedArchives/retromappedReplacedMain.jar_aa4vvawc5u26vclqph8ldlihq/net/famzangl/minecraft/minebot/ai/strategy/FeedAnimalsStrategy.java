		...
		if (found != null) {
			addTask(new FaceAndInteractTask(found, selector) {
					...
					h.selectCurrentItem(new ItemFilter() {
						...
						public boolean matches(ItemStack itemStack) {
							return itemStack == null
									...
									|| !(itemStack.func_77973_b() == Items.field_151015_O
											|| itemStack.func_77973_b() == Items.field_151172_bF || itemStack
											.func_77973_b() instanceof ItemSeeds);
						}
					});
					super.runTick(h, o);
				}
				...
				protected void doInteractWithCurrent(AIHelper h) {
					final Entity over = h.getObjectMouseOver().field_72308_g;
