...
public class BuildMarkerRenderer extends RenderHelper {
	...
	private final class CornerComparator implements Comparator<BuildTask> {
		...
		public int compare(BuildTask o1, BuildTask o2) {
			...
			final int[] points = new int[] { p1.func_177958_n(), p1.func_177956_o(), p1.func_177952_p() };
			final int[] points2 = new int[] { p2.func_177958_n(), p2.func_177956_o(), p2.func_177952_p() };
			for (int i = 0; i < 3; i++) {
