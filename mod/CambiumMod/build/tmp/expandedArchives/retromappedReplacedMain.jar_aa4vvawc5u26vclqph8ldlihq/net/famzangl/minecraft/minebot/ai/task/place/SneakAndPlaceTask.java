...
public class SneakAndPlaceTask extends AITask {
	...
	public SneakAndPlaceTask(BlockPos destinationStandPosition, BlockItemFilter filter,
		...
		final EnumFacing foundInDir = AIHelper.getDirectionFor(destinationStandPosition.func_177973_b(startStandPosition));
		if (foundInDir.func_96559_d() != 0 || foundInDir == null) {
	...
	protected BlockPos getPositionToPlaceAt() {
		return destinationStandPosition.func_177982_a(0, -1, 0);
	}
	...
	public void runTick(AIHelper h, TaskOperations o) {
		...
		if (h.sneakFrom(getFromPos(), inDirection, faceWhileSneaking())) {
			final boolean hasRequiredHeight = h.getMinecraft().field_71439_g
					.func_174813_aQ().field_72338_b > minBuildHeight - 0.05;
	...
	protected BlockPos getPositionToPlaceOn() {
		return startStandPosition.func_177982_a(0, -1, 0);
	}
