...
public abstract class PutItemInContainerTask extends AITask {
	...
	public boolean isFinished(AIHelper h) {
		...
		return screen != null
				&& placed
				&& (slotToPlace < 0 || isFull || !screen.field_147002_h
						.func_75139_a(slotToPlace).func_75216_d());
	}
	...
	public void runTick(AIHelper h, TaskOperations o) {
		...
		if (slotToPlace < 0) {
			...
			Slot slot = screen.field_147002_h.func_75139_a(slotToPlace);
			int oldContent, newContent = getSlotContentCount(slot);
			do {
				oldContent = newContent;
				h.getMinecraft().field_71442_b.func_78753_a(
						screen.field_147002_h.field_75152_c, slotToPlace, 0, 1,
