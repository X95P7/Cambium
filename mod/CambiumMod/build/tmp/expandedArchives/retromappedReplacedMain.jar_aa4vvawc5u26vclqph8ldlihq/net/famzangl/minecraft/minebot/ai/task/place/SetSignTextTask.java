...
public class SetSignTextTask extends AITask {
	...
	public boolean isFinished(AIHelper h) {
		return guiOpened && h.getMinecraft().field_71462_r == null;
	}
	...
	public void runTick(AIHelper h, TaskOperations o) {
		if (!guiOpened) {
			// wait
			guiOpened = h.getMinecraft().field_71462_r instanceof GuiEditSign;
		} else {
			if (timer == 0) {
				TileEntitySign sign = (TileEntitySign) h.getMinecraft().field_71441_e
						.func_175625_s(pos);
				// sign.signText = text;
			} else if (timer == 5) {
