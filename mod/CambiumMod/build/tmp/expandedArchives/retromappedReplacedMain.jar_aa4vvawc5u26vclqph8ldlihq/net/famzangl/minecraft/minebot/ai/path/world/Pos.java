...
public class Pos {
	...
	public static BlockPos minPos(BlockPos p1, BlockPos p2) {
		return new BlockPos(Math.min(p1.func_177958_n(), p2.func_177958_n()), Math.min(p1.func_177956_o(), p2.func_177956_o()), Math.min(
				p1.func_177952_p(), p2.func_177952_p()));
	}

	public static BlockPos maxPos(BlockPos p1, BlockPos p2) {
		return new BlockPos(Math.max(p1.func_177958_n(), p2.func_177958_n()), Math.max(p1.func_177956_o(), p2.func_177956_o()), Math.max(
				p1.func_177952_p(), p2.func_177952_p()));
	}
