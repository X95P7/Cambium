...
public class BlockBounds {
	...
	public BlockBounds(Block block) {
		this.minX = block.func_149704_x();
		this.maxX = block.func_149753_y();
		this.minY = block.func_149665_z();
		this.maxY = block.func_149669_A();
		this.minZ = block.func_149706_B();
		this.maxZ = block.func_149693_C();
	}
...
//		return FULL_BLOCK;
	...
	public Vec3 random(BlockPos pos, double centered) {
		return new Vec3(
				pos.func_177958_n() + RandUtils.getBetweenCentered(minX, maxX, centered),
				pos.func_177956_o() + RandUtils.getBetweenCentered(minY, maxY, centered),
				pos.func_177952_p() + RandUtils.getBetweenCentered(minZ, maxZ, centered));
	}
