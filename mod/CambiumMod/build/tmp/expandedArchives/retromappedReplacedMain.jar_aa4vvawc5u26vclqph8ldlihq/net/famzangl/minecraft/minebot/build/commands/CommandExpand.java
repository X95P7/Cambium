	...
	private static final class ExpandStrategy extends RunOnceStrategy {
		...
		protected void singleRun(AIHelper helper) {
			...
			if (dir.func_177958_n() != 0) {
				usePos2 = (pos1.func_177958_n() < pos2.func_177958_n() == dir.func_177958_n() > 0);
			} else if (dir.func_177956_o() != 0) {
				usePos2 = (pos1.func_177956_o() < pos2.func_177956_o() == dir.func_177956_o() > 0);
			} else {
				usePos2 = (pos1.func_177952_p() < pos2.func_177952_p() == dir.func_177952_p() > 0);
			}
			BlockPos old;
			if (usePos2) {
				old = pos2;
			...
			BlockPos newPos = old.func_177967_a(direction, amount);
	...
	public static AIStrategy run(
		...
		if (direction == null) {
			System.out.println("Pitch: "
					+ helper.getMinecraft().field_71439_g.field_70125_A);
