...
public final class FilterFeedingItem implements ItemFilter {
	...
	private boolean isFeedingItem(final EntityAnimal animal,
		...
		return currentItem != null && currentItem.func_77973_b() != null
				&& animal.func_70877_b(currentItem) && !animal.func_70880_s()
				&& (animal.func_70874_b() == 0 || isHungryWolf(animal))
				&& animal.func_110143_aJ() > 0;
	}

	private boolean isHungryWolf(EntityAnimal animal) {
		return animal instanceof EntityWolf
				&& animal.func_110143_aJ() < animal.func_110138_aP();
	}
}