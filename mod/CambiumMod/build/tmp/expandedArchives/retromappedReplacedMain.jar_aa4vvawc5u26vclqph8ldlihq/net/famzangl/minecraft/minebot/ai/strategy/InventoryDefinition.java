...
public class InventoryDefinition {
	...
	public static class InventorySlot {
		...
		public InventorySlot(int slotIndex, int amount, int itemId,
				int damageValue) {
			super();
			if (itemId != 0 && Item.func_150899_d(itemId) == null) {
	...
	public InventoryDefinition(InventoryPlayer player) {
		for (int i = 0; i < 36; i++) {
			...
			stack.func_77973_b();
			slots.add(new InventorySlot(i, stack.field_77994_a, Item
					.func_150891_b(stack.func_77973_b()),
					stack.func_77981_g() ? stack.func_77952_i() : -1));
		}
	}
