...
public class BlockRangeScanner {
	...
	public void scanArea(WorldData world) {
		BlockCuboid area = new BlockCuboid(center.func_177982_a(-HORIZONTAL_SCAN,  -VERTICAL_SCAN, -HORIZONTAL_SCAN), center.func_177982_a(HORIZONTAL_SCAN,  VERTICAL_SCAN, HORIZONTAL_SCAN));
