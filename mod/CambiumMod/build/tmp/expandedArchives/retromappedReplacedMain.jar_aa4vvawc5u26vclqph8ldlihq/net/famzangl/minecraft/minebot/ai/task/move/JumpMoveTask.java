...
public class JumpMoveTask extends HorizontalMoveTask {
	...
	protected boolean doJump(AIHelper h) {
		...
		return player.func_177958_n() != pos.func_177958_n() || player.func_177952_p() != pos.func_177952_p();
	}

	@Override
	public void runTick(AIHelper h, TaskOperations o) {
		if (!BlockSets.HEAD_CAN_WALK_TRHOUGH.isAt(h.getWorld(), oldX, pos.func_177956_o() + 1, oldZ)) {
	...
	private BlockPos toDestroyForJump() {
		return new BlockPos(oldX, pos.func_177956_o() + 1, oldZ);
	}
	@Override
	public boolean applyToDelta(WorldWithDelta world) {
		world.setBlock(toDestroyForJump(), Blocks.field_150350_a);
