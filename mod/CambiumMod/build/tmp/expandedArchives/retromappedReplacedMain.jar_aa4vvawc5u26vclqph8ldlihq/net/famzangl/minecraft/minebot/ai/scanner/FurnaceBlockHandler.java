	...
	public static class FurnaceData {
		...
		private static boolean isFuel(ItemWithSubtype item) {
			...
			return TileEntityFurnace.func_145954_b(stack)
					|| SlotFurnaceFuel.func_178173_c_(stack);
		}

		public boolean couldPut(ItemWithSubtype item) {
			ItemStack result = FurnaceRecipes.func_77602_a().func_151395_a(
		...
		public void update(GuiFurnace screen) {
			...
			ItemStack burn = inv.func_70301_a(0);
			ItemStack fuel = inv.func_70301_a(1);
			ItemStack result = inv.func_70301_a(2);
			...
			isFullBurn = burn != null
					&& burn.func_77976_d() <= burn.field_77994_a;
			isFullFuel = fuel != null
					&& fuel.func_77976_d() <= fuel.field_77994_a;
		...
		public void update(AIHelper h) {
			update((GuiFurnace) h.getMinecraft().field_71462_r);
		}
