...
public class SlabBuildTask extends BlockBuildTask {
	...
	public AITask getPlaceBlockTask(BlockPos relativeFromPos) {
		if (!isStandablePlace(relativeFromPos)) {
			...
			return new JumpingPlaceAtHalfTask(forPosition.func_177982_a(0, 1, 0),
					getItemToPlaceFilter(), getHalf());
		} else {
			return new SneakAndPlaceAtHalfTask(forPosition.func_177982_a(0, 1, 0),
					getItemToPlaceFilter(), forPosition.func_177971_a(relativeFromPos),
