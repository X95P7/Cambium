...
public final class PlayerPositionLabel extends JPanel {
	...
	public void setPosition(BlockPos newPlayer) {
		x.setText(newPlayer == null ? "?" : newPlayer.func_177958_n() + "");
		y.setText(newPlayer == null ? "?" : newPlayer.func_177956_o() + "");
		z.setText(newPlayer == null ? "?" : newPlayer.func_177952_p() + "");
		
		String pos = newPlayer == null ? "?" : newPlayer.func_177958_n() + " " + newPlayer.func_177956_o() + " " + newPlayer.func_177952_p();
