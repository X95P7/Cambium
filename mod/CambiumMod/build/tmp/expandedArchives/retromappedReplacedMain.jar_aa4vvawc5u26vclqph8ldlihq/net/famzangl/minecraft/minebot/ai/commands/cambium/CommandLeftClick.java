...
public class CommandLeftClick {
	@AICommandInvocation()
	public static AIStrategy run(
			AIHelper helper,

			//Change paramters to fit command
			@AICommandParameter(type = ParameterType.FIXED, fixedName = "attack", description = "") String nameArg,
		...
		return new LeftClickStrategy(n, ticks, helper);
	}
}
