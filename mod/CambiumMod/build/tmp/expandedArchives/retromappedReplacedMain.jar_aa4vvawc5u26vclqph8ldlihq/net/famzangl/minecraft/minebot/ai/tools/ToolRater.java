...
public class ToolRater {
	...
	private static class Depleted implements ItemFilter {
		...
		public boolean matches(ItemStack itemStack) {
			return itemStack != null
					&& itemStack.func_77984_f()
					&& (itemStack.func_77958_k() - itemStack.func_77952_i()) <= 1;
		}
	...
	private static class ItemMaterial implements ItemFilter {
		...
		public boolean matches(ItemStack itemStack) {
			if (itemStack == null) {
				...
				return itemTool.func_150913_i() == toolMaterial;
			} else if (itemStack.func_77973_b() instanceof ItemHoe) {
				ItemHoe itemTool = (ItemHoe) itemStack.func_77973_b();
				return itemTool.func_77842_f().equals(toolMaterial.toString());
			} else {
				return false;
			}
		}
	...
	public enum ToolType implements ItemFilter {
		...
		public boolean matches(ItemStack itemStack) {
			return itemStack != null && itemStack.func_77973_b() != null
					&& itemClass.isInstance(itemStack.func_77973_b());
		}
	...
	static {
		ENCHANTMENTS.put("efficiency", Enchantment.field_77349_p.field_77352_x);
		ENCHANTMENTS.put("fortune", Enchantment.field_77346_s.field_77352_x);
		ENCHANTMENTS.put("unbreaking", Enchantment.field_77347_r.field_77352_x);
		ENCHANTMENTS.put("silk_touch", Enchantment.field_77348_q.field_77352_x);
	}
