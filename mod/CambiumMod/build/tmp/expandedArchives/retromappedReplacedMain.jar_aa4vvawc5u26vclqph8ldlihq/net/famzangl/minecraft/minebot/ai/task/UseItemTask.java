	...
	public void runTick(AIHelper h, TaskOperations o) {
		if (!clicked) {
			...
			if (objectMouseOver == null
					|| objectMouseOver.field_72313_a != MovingObjectPosition.MovingObjectType.BLOCK) {
				notFacingBlock(h);
				return;
			}
			// Check is facing to make sure top facing check passed.
			if (!h.isFacingBlock(objectMouseOver.func_178782_a())
					|| !isBlockAllowed(h, objectMouseOver.func_178782_a())) {
				notFacingBlock(h);
				return;
			}
