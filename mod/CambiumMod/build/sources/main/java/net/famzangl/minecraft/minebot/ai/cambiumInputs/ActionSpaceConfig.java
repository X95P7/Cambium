...
public class ActionSpaceConfig {
    ...
    // Look discretization (must match YAW_BINS/PITCH_BINS arrays in fast_rl_model.py)
    public int yawBins = 9;  // 9 discrete yaw deltas
    public int pitchBins = 5; // 5 discrete pitch deltas
