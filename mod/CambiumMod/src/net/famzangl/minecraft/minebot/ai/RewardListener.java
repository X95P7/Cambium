...
public class RewardListener {
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (closestEnemy != null) {
            ...
            double targetY = closestEnemy.posY + 0.9; // Approximate center of player hitbox
            double dx = closestEnemy.posX - player.posX;
            double dy = targetY - (player.posY + player.getEyeHeight()); // Aim from our eyes to their body center
